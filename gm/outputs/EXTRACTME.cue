...
mesh_configs: redis_config +
	...
	dashboard_config +
	catalog_entries +
	[ for x in multimesh_bridge_config if config.enable_multimesh_bridge {x}] +
...
multimesh_bridge_mesh_configs_yaml: yaml.MarshalStream(multimesh_bridge_mesh_configs)
